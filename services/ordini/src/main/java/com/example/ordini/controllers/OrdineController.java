...
public class OrdineController {
    ...
    public ResponseEntity<List<OrdineResponse>> getOrdineByCarrelloId(@PathVariable Long id_carrello) {
        return new ResponseEntity<>(ordineService.getOrdineByCarrelloId(id_carrello), HttpStatus.OK);
    }
